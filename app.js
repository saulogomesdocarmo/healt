...
function calcular() {
    ...
    if (frmHealth.txtIdade.value === "") {
        ...
        //Passo 2: exercutar uma forma diferente para o sexo selecionado 
        if (document.getElementById("m").checked === true) {
            // console.log("Fórmula para homens")
            get = (66 + (13.7 * peso) + (5 *z (altura * 100) - (6.8 * idade))) * valor
        }
        if (document.getElementById("f").checked === true) {
            // console.log("Fórmula para mulher")
...
function limpar() {
    document.getElementById('grafico').innerHTML = "IMC"
